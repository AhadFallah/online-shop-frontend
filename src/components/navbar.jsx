  ...
  return (
    <div class="fixed bottom-0 z-50 w-full -translate-x-1/2 bg-white border-t border-gray-200 left-1/2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="grid h-full max-w-lg grid-cols-5 mx-auto" dir="rtl">
        ...
        >
          <svg
             class={"w-5 h-5 mb-1"+ (props.login?" text-blue-400 ":null) +"text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"}            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            aria-hidden="true"
            fill="currentColor"
          >
        ...
        >
          <svg
            class={"w-5 h-5 mb-1"+ (props.house?" text-blue-400 ":null) +"text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        >
          <svg
            ...
            class={"w-5 h-5 mb-1"+ (props.search?" text-blue-400 ":null) +"text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"}
